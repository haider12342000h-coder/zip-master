...
const MOCK_CASES: LegalCase[] = [
  {
    ...
    lawyer: { name: 'د. عمر النعيمي', role: 'محامي نقض - تجاري وشركات', img: 'https://i.pravatar.cc/150?img=33' },
    status: 'review',
    ...
    unreadCount: 2,
    customFields: [
      { id: 'cf-1', label: 'نوع العقار', value: 'تجاري' },
      { id: 'cf-2', label: 'رقم الصك', value: '47291048' },
      { id: 'cf-3', label: 'المدينة', value: 'الرياض' }
    ],
    folders: [
      { id: 'f-1', name: 'العقود والملاحق' }
    ],
    documents: [
      {
        id: 'doc-1',
        ...
        tags: ['مسودة', 'عقارات'],
        previewUrl: 'https://images.unsplash.com/photo-1568225367116-ce0f2092bccd?q=80&w=200&auto=format&fit=crop',
        uploadedAt: '2026-04-12T10:00:00.000Z'
      },
      {
        id: 'doc-1b',
        name: 'الهوية_الوطنية.jpg',
        size: '0.4 MB',
        date: '10 نيسان',
        type: 'image',
        folderId: null,
        ...
        expiresText: 'تنتهي الصلاحية قريباً',
        previewUrl: 'https://images.unsplash.com/photo-1633265486064-086b219458ce?q=80&w=200&auto=format&fit=crop',
        uploadedAt: '2026-04-10T12:00:00.000Z'
      }
    ],
    aiConsultations: [
      { id: 'aic-1', title: 'خلاصة تحليل العقد المبدئي', date: '11 نيسان', excerpt: 'استنتاج المستشار الذكي حول بنود التجديد التلقائي وتحليل المخاطر...' }
    ],
    messages: [
      { id: 1, sender: 'lawyer', text: 'أهلاً بك، لقد استلمت مسودة العقد وسأقوم بمراجعتها خلال 24 ساعة.', time: '10:00 ص' },
      { id: 2, sender: 'user', text: 'شكراً دكتور. يرجى التركيز على البند الرابع الخاص بالصيانة.', time: '10:15 ص' }
    ],
    timeline: [
      { id: 't-1', date: '12 نيسان', title: 'تم فتح ملف القضية', detail: 'قام العميل ببدء طلب المراجعة للعقد التجاري.', type: 'system' },
      { id: 't-2', date: '12 نيسان', title: 'رفع المسودة الأولى', detail: 'تم إدراج ملف PDF الخاص بمسودة العقد.', type: 'filing' },
      { id: 't-3', date: '13 نيسان', title: 'جلسة مراجعة هاتفية', detail: 'مناقشة تفاصيل بنود الصيانة والتأمين.', type: 'meeting' }
    ],
    financials: {
      totalAgreed: 1200000,
      paid: 400000,
      invoices: [
        { id: 'INV-101', amount: 400000, date: '12 نيسان 2026', status: 'paid' },
        { id: 'INV-102', amount: 800000, date: '01 أيار 2026', status: 'pending' }
      ]
    }
  },
  {
    ...
    lawyer: { name: 'المحامية سجا كاظم', role: 'ملكية فكرية', img: 'https://i.pravatar.cc/150?img=47' },
    status: 'closed',
    statusText: 'مكتملة',
    progress: 100,
    date: '05 نيسان 2026',
    customFields: [
      { id: 'cf-4', label: 'اسم العلامة', value: 'ديليشس برجر' },
      { id: 'cf-5', label: 'الفئة', value: '43 (مطاعم)' }
    ],
    folders: [],
    documents: [
      {
        id: 'doc-2',
        name: 'شهادة_التسجيل.jpg',
        size: '2.5 MB',
        date: '08 نيسان',
        type: 'image',
        folderId: null,
        actionRequired: null,
        previewUrl: 'https://images.unsplash.com/photo-1589829085413-56de8ae18c73?q=80&w=200&auto=format&fit=crop',
        uploadedAt: '2026-04-08T09:00:00.000Z'
      },
      {
        id: 'doc-3',
        name: 'الرسوم_والمتطلبات.pdf',
        size: '0.8 MB',
        date: '05 نيسان',
        type: 'pdf',
        folderId: null,
    ...
    aiConsultations: [],
    messages: [
      { id: 1, sender: 'user', text: 'مرحباً، أود تسجيل علامة تجارية لمطعمي الخاص.', time: '09:00 ص' },
      { id: 2, sender: 'lawyer', text: 'أهلاً بك. يرجى إرفاق الشعار المقترح وصورة من هويتك لنبدأ الفحص الشكلي.', time: '09:30 ص' },
      { id: 3, sender: 'lawyer', text: 'تم التسجيل بنجاح، الشهادة مرفقة في قسم الوثائق.', time: '02:00 م (قبل أسبوع)' }
    ],
    timeline: [
      { id: 't-a', date: '05 نيسان', title: 'تقديم طلب العلامة', detail: 'بدء الإجراءات الرسمية لدى وزارة الصناعة.', type: 'filing' },
      { id: 't-b', date: '08 نيسان', title: 'صدور الشهادة', detail: 'تم اعتماد العلامة التجارية رسمياً.', type: 'system' }
    ],
    financials: {
      totalAgreed: 850000,
      paid: 850000,
      invoices: [
        { id: 'INV-098', amount: 850000, date: '05 نيسان 2026', status: 'paid' }
      ]
    }
  }
];
